...
$sql="update regis set id=$id,name='$name',email='$email',mobile='$mobile',destination='$destination' where id=$id";
$result=mysqli_query($con,$sql);
if($result){
      ...
      <li class="nav-item"><a class="nav-link" href="display.php">Admin</a></li>
			...
			<form method="post">
				...
				<div class="form-group">
					...
					<input type="destination" class="form-control" placeholder="Please enter your destination" name="destination" autocomplete="off" value=<?php echo $destination;?>>
				</div>
